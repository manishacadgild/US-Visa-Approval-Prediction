...
class TrainPipeline:
    def __init__(self):
        ...
        self.model_evalutaion_config=ModelEvaluationConfig()
    ...
    def start_model_evalutaion(self,data_ingestion_artifact:DataIngestionArtifact,
        ...
        try:
            model_evaluation=ModelEvaluation(model_eval_config=self.model_evalutaion_config,
    ...
    def run_pipeline(self,):
        """
         This pipline is responsible for run the complete pipeline
        ...
        try:
            ...
            model_evaluation_artifact=self.start_model_evalutaion(data_ingestion_artifact=data_ingestion_artifact,model_trainer_artifact=model_trainer_artifact)
